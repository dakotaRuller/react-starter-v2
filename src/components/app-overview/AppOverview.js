...
const AppOverview = () => {
  ...
  return (
      ...
      <p>Hey there friend, new to React? I’d suggest playing around with <a className={"link-highlight"} href="https://www.npmjs.com/package/create-react-app" target="_blank">create-react-app</a> before trying to dig into this application too much but then again I’m not here to tell you what to do. Live your life. Anyways lets get into it. Think of this application as something similar to create-react-app but more basic and custom. You’ll learn more about the ins-and-outs of whats going on as you read on and visit the different pages.</p>
      <p>Getting started with this app you'll need to know the basics of what's going on. So let's start with a list of the main technologies/libraries holding this freakin application together:
      </p>
      <ul>
        ...
        {/*TODO: Figure out a solution to the frontend of the "Link" component coming from react-router-dom onClick*/}
          <Link className={"link-highlight"} to={appRoutes.webpackBabelOverview}>Webpack/Babel</Link>
    </div>
  )
};
